...
AGENT_KEYWORDS = {
    ...
    "education":    [
        ...
        "what is", "what are", "how to fix", "how to solve",
        "what causes", "why is", "how does", "what happens",
...
EXCLUSIVE_TASKS = {
    ...
    "i am a developer":      "conversation",
    "how to fix":            "education",
    "how to solve":          "education",
    "what is quantum":       "education",
    "what is machine":       "education",
    "what is artificial":    "education",
    "what is deep learning": "education",
    "what is blockchain":    "education",
    "what is cloud":         "education",
    "i am a student":        "conversation",
    "i am from":             "conversation",
    "i am working on":       "conversation",
    "i work at":             "conversation",
    "i live in":             "conversation",
    "my name is":            "conversation",
    "call me":               "conversation",
    "i love":                "conversation",
    "i like":                "conversation",
    "i enjoy":               "conversation",
    "give me ideas":         "spark",
    "business ideas":        "spark",
    "startup ideas":         "spark",
    "project ideas":         "spark",
    "what should i build":   "spark",
    "suggest ideas":         "spark",
    "idea for":              "spark",
    "tinku spark":           "spark",
}
