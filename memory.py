...
MEMORY_PATTERNS = [
    ...
    # Profession
    (r"i(?:'m| am) (?:a |an )?([a-z]*(?: ?(?:developer|engineer|designer|student|teacher|doctor|manager|analyst|scientist|architect|writer|artist)))", "profession"),
