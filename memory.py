...
MEMORY_PATTERNS = [
    ...
    (r"i(?:'m| am) ([A-Z][a-z]+(?: [A-Z][a-z]+)*)", "name"),
    (r"call me ([A-Z][a-z]+(?: [A-Z][a-z]+)*)", "name"),
    ...
    # Profession
    (r"i(?:'m| am) a ([a-z]+ (?:developer|engineer|designer|student|teacher|doctor|manager|analyst|scientist|architect|writer|artist))", "profession"),
    (r"i work as a ([a-z ]+?)(?:\.|,|$)", "profession"),
    (r"i(?:'m| am) studying ([a-z ]+?)(?:\.|,|$)", "profession"),
    (r"my profession is ([a-z ]+?)(?:\.|,|$)", "profession"),

    # Interests
    (r"i (?:love|like|enjoy|prefer) ([a-z ]+?)(?:\.|,|$)", "interest"),
